...
const createElement = (id, x1, y1, x2, y2, type) => {
  switch (type) {
    ...
    case "rectangle":
      const roughElement =
        type === "line"
          ? generator.line(x1, y1, x2, y2, { roughness: 0, stroke: "black" })
          : generator.rectangle(x1, y1, x2 - x1, y2 - y1, { roughness: 0, stroke: "black" });
...
const drawElement = (roughCanvas, context, element) => {
  switch (element.type) {
    case "line":
    case "rectangle":
      roughCanvas.draw(element.roughElement, { stroke: "black" });
      break;
    case "pencil":
